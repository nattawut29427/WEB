<template>
      <div
        class="card rounded-[24px]  ml-20 h-80 lg:w-[390px] lg:h-[400px] text-white bg-l_Gray shadow-xl"
        ...
        <NuxtLink  :to=user.link_page><figure>
  ...
  import { ref } from "vue";
  import userData from "/Data/DB_cardpagenore.json";
