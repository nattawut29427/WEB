            ...
            <div class="nav flex  justify-between">
                <div class="navv flex w-[500px] pl-2 ">
                    ...
                    <div class="imge w-[125px] p-5 flex flex-wrap gap-5 ">
                        <nuxtImg  class="w-fit" :src="infos[0].img2" alt="" />
                        <nuxtImg  class="w-fit" :src="infos[0].img3" alt="" />
                        <nuxtImg  class="w-fit"  :src="infos[0].img4" alt="" />
                        <nuxtImg  class="w-fit" :src="infos[0].img5" alt="" />
                ...
                <div class="navvv pr-2 pt-10 w-[50%]">
                    ...
                    <div >
                        ...
                        <div class="flex">
                            <div>
                                <span class="text-M_Blue">สถานะสินค้า :</span> <span class="text-red-500">มือสอง</span><br>
                                <span class="text-M_Blue">ยี่ห้อ :</span> <span class="text-red-500">Vans</span><br>
                                <span class="text-M_Blue">ขนาด :</span> <span class="text-red-500">42Eu 27cm</span><br>
                                <span class="text-M_Blue">ประเภท :</span> <span class="text-red-500">รองเท้า</span><br>
            ...
            <div class="hero w-[50%] h-32 br-5 rounded-2xl flex bg-gradient-to-r from-blue to-cyc   ">
                ...
                <div class="vv pl-32  ">
                    ...
                    <div class="w-5 grid ml-3 lg:w-full lg:flex lg:ml-3 ">
                        <a href="/traveler/products/userpro"><button class="btn rounded-full text-sm hover:bg-D_Blue bg-M_Light text-M_Blue hover:text-M_Light mt-1 h-[40px] w-[120px] border-none ">
                            <p>ดูร้านค้า</p>
                        </button></a>
                    </div>
                </div>
